...
unsigned int p, q, r;
unsigned int led_state, rgb_led_state = 0;
unsigned int stable0, stable1, stable2, stable3 = 0;
float rotation_angle0, rotation_angle1 = 0.0;
unsigned int faces[NUM_ROBOTS_MAX];
double x1, y1, x2, y2, x3, y3, x2_ref, y2_ref, x3_ref, y3_ref;
...
void positionControlExec() {
	...
	r = particleOfRobot[2];
#ifdef LINE
	std::cout << "Line Formation" << std::endl;
...
#endif
#ifdef TRIANGLE
	std::cout << "Triangle Formation" << std::endl;
	led_state = (led_state == 1) ? 0 : 1;
	/* for (i = 0; i < 3; i++) {
		for (j = 0; j < 4; j++) {
			robots[i].setLed(j, led_state);
		}
	}
	for (i = 0; i < 3; i++) {
		...
		case 0:
			for (j = 0; j < 4; j++) {
				robots[i].setRgbLeds(10, 0, 0, 10, 0, 0, 10, 0, 0, 10, 0, 0);
			}
			rgb_led_state = 1;
			break;
		case 1:
			for (j = 0; j < 4; j++) {
				robots[i].setRgbLeds(0, 10, 0, 0, 10, 0, 0, 10, 0, 0, 10, 0);
			}
			rgb_led_state = 2;
			break;
		case 2:
			for (j = 0; j < 4; j++) {
				robots[i].setRgbLeds(0, 0, 10, 0, 0, 10, 0, 0, 10, 0, 0, 10);
			}
			rgb_led_state = 3;
			break;
		case 3:
			for (j = 0; j < 4; j++) {
				robots[i].setRgbLeds(10, 10, 0, 10, 10, 0, 10, 10, 0, 10, 10, 0);
			}
			rgb_led_state = 4;
			break;
		case 4:
			for (j = 0; j < 4; j++) {
				robots[i].setRgbLeds(0, 10, 10, 0, 10, 10, 0, 10, 10, 0, 10, 10);
			}
			rgb_led_state = 5;
			break;
		case 5:
			for (j = 0; j < 4; j++) {
				robots[i].setRgbLeds(10, 0, 10, 10, 0, 10, 10, 0, 10, 10, 0, 10);
			}
			rgb_led_state = 6;
			break;
		case 6:
			for (j = 0; j < 4; j++) {
				robots[i].setRgbLeds(10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10);
			}
			rgb_led_state = 0;
			break;
		}
	...
	if ( robots[2].getDistanceMillimeters() >= 90 && y1 < 400.0 ) {
		std::cout << "Robot2 (Squadron Leader) Orientation: Front facing" << std::endl;
		faces[2] = 0;
		x2_ref = x1 - 100.0;
		...
		if ( abs(y2_ref - y2) >= 90.0 ) {
			std::cout << "Robot0 y-stability: False" << std::endl;
			stable0 = 0;
		}
		if ( abs(y3_ref - y3) >= 90.0 ) {
			std::cout << "Robot1 y-stability: False" << std::endl;
			stable1 = 0;
		}
		...
		if ( stable0 == 0 && stable2 == 0 && faces[0] != 0 ) {
			...
			std::cout << "Robot0 rotational-stability: False" << std::endl;
			while (1) {
		...
		if ( ( stable0 == 0 ) && ( stable2 == 0 ) && ( (y2_ref - y2) >= 2.0 ) ) {
			std::cout << "Moving Robot0 backward to achieve y-stability..." << std::endl;
			robots[0].setSpeed(-200, -200);
			return;
		}
		else if ( ( stable0 == 0 ) && ( stable2 == 0 ) && ( (y2 - y2_ref) >= 2.0 ) ) {
			std::cout << "Moving Robot0 forward to achieve y-stability..." << std::endl;
			robots[0].setSpeed(200, 200);
			return;
		}
		else if ( ( stable0 == 0 ) ) {
			std::cout << "Robot0 y-stability: True | rotational-stability: True" << std::endl;
			robots[0].setSpeed(0, 0);
			stable0 = 1;
		}
		else {
		...
		if ( stable1 == 0 && stable3 == 0 && faces[1] != 0 ) {	
			...
			std::cout << "Robot1 rotational-stability: False" << std::endl;
			while (1) {
		...
		if ( ( stable1 == 0 ) && ( stable3 == 0 ) && ( (y3_ref - y3) >= 2.0 ) ) {
			std::cout << "Moving Robot1 backward to achieve y-stability..." << std::endl;
			robots[1].setSpeed(-200, -200);
			return;
		}
		else if ( ( stable1 == 0 ) && ( stable3 == 0 ) && ( (y3 - y3_ref) >= 2.0 ) ) {
			std::cout << "Moving Robot1 forward to achieve y-stability..." << std::endl;
			robots[1].setSpeed(200, 200);
			return;
		}
		else if ( stable1 == 0 ) {
			std::cout << "Robot1 y-stability: True | rotational-stability: True" << std::endl;
			robots[1].setSpeed(0, 0);
			stable1 = 1;
		}
		else {
		...
		// Robots are facing forward and Y-stability has been achieved
		if ( ( stable0 == 1 ) && ( stable2 == 0 ) && ( (x2 - x2_ref) >= 2.0 ) ) {
			std::cout << "Robot0 x-stability: False" << std::endl;
			if ( faces[0] != 1 ) {
				while (1) {
					rotation_angle0 += (robots[0].getGyroRaw(2) - 0.0) * (250.0 / 32768.0) * (3.14 / 180.0);
			...
			if (faces[0] == 1) {
				std::cout << "Robot0 left turn: Complete" << std::endl;
				std::cout << "Moving Robot0 left..." << std::endl;
				robots[0].setSpeed(200, 200);
			}
			return;
		}
			...
			if (faces[0] == 3) {
				std::cout << "Robot0 right turn: Complete" << std::endl;
				std::cout << "Moving Robot0 right..." << std::endl;
				robots[0].setSpeed(200, 200);
			}
			return;
		}
		else if ( ( stable0 == 1 ) && ( stable2 == 0 ) && ( abs(x2_ref - x2) < 2.0 ) ) {
			std::cout << "Robot0 x-stability: True" << std::endl;
			m = (faces[0] >= 1) ? (4 - faces[0]) : 0;
			std::cout << "Robot0 rotational-stability: False" << std::endl;
			if ( faces[0] != 0 ) {
				while (1) {
		...
		if ( ( stable1 == 1 ) && ( stable3 == 0 ) && ( (x3 - x3_ref) >= 2.0 ) ) {
			std::cout << "Robot1 x-stability: False" << std::endl;
			if ( faces[1] != 1 ) {
				while (1) {
					rotation_angle1 += (robots[1].getGyroRaw(2) - 0.0) * (250.0 / 32768.0) * (3.14 / 180.0);
			...
			if (faces[1] == 1) {
				std::cout << "Robot1 left turn: Complete" << std::endl;
				std::cout << "Moving Robot1 left..." << std::endl;
				robots[1].setSpeed(200, 200);
			}
			return;
		}
			...
			if (faces[1] == 3) {
				std::cout << "Robot1 right turn: Complete" << std::endl;
				std::cout << "Moving Robot1 right..." << std::endl;
				robots[1].setSpeed(200, 200);
			}
			return;
		}
		else if ( ( stable1 == 1 ) && ( stable3 == 0 ) && ( abs(x3_ref - x3) < 2.0 ) ) {
			std::cout << "Robot1 x-stability: True" << std::endl;
			m = (faces[1] >= 1) ? (4 - faces[0]) : 0;
			std::cout << "Robot1 rotational-stability: False" << std::endl;
			if ( faces[1] != 0 ) {
				while (1) {
	...
	/* else if ( ( robots[2].getDistanceMillimeters() <= 30 ) && ( x1 < 100.0 ) ) {
		faces[2] = 3;
		x2_ref = x1 + 100.0;
		y2_ref = y1 - ( sqrt(3) * (x2_ref - x1) );
		x3_ref = x1 + 100.0;
		y3_ref = y1 + ( sqrt(3) * (x3_ref - x1) );
		if ( abs(y2_ref - y2) >= 2.0 ) {
			stable0 = 0;
		}
		if ( abs(y3_ref - y3) >= 2.0 ) {
			stable1 = 0;
		}
		if ( stable0 == 0 && faces[0] != 0 ) {
			while ( abs(rotation_angle0) <= ( (0 - faces[0]) * 15.25 ) ) {
				robots[0].setSpeed(100, -100);
				rotation_angle0 += (robots[0].getGyroRaw(2) - 0.0) * (250.0 / 32768.0) * (3.14 / 180.0);
			}
			rotation_angle0 = 0.0;
			faces[0] = 0;
		...
		if ( stable1 == 0 && faces[1] != 0 ) {
			while ( abs(rotation_angle1) <= ( (0 - faces[1]) * 15.25 ) ) {
				robots[1].setSpeed(100, -100);
				rotation_angle1 += (robots[0].getGyroRaw(2) - 0.0) * (250.0 / 32768.0) * (3.14 / 180.0);
			}
			rotation_angle1 = 0.0;
			faces[1] = 0;
			robots[1].setSpeed(0, 0);
		...
		if ( ( stable0 == 1 ) && ( (x2_ref - x2) >= 2.0 ) ){
			while ( ( complete0 == 0 ) && ( abs(rotation_angle0) <= 15.25 ) ) {
				robots[0].setSpeed(-100, 100);
				rotation_angle0 += (robots[0].getGyroRaw(2) - 0.0) * (250.0 / 32768.0) * (3.14 / 180.0);
			}
			rotation_angle0 = 0.0;
			faces[0] = ( faces[0] < 3 ) ? ( faces[0] + 1 ) : 0;
			complete0 = 1;
			robots[0].setSpeed(200, 200);
		}
		else if ( ( stable0 == 1 ) && ( (x2 - x2_ref) >= 2.0 ) ) {
			while ( ( complete0 == 0 ) && ( abs(rotation_angle0) <= 15.25 ) ) {
				robots[0].setSpeed(100, -100);
				rotation_angle0 += (robots[0].getGyroRaw(2) - 0.0) * (250.0 / 32768.0) * (3.14 / 180.0);
			}
			rotation_angle0 = 0.0;
			faces[0] = ( faces[0] > 0 ) ? ( faces[0] - 1 ) : 3;
			complete0 = 1;
			robots[0].setSpeed(200, 200);
		}
		else if ( ( stable0 == 1) && ( abs(x2_ref - x2) < 2.0 ) ) {
			m = ( (faces[2] - faces[0]) >= 0 ) ? 1 : -1;
			while ( abs(rotation_angle0) <= ((faces[2] - faces[0]) * 15.25) ) {
				robots[0].setSpeed( (-m * 100), (m * 100) );
				rotation_angle0 += (robots[0].getGyroRaw(2) - 0.0) * (250.0 / 32768.0) * (3.14 / 180.0);
			}
			rotation_angle0 = 0.0;
			faces[0] = faces[2];
		...
		if ( ( stable1 == 1 ) && ( (x3_ref - x3) >= 2.0 ) ) {
			while ( ( complete1 == 0 ) && ( abs(rotation_angle1) <= 15.25 ) ) {
				robots[1].setSpeed(-100, 100);
				rotation_angle1 += (robots[1].getGyroRaw(2) - 0.0) * (250.0 / 32768.0) * (3.14 / 180.0);
			}
			rotation_angle1 = 0.0;
			faces[1] = ( faces[1] < 3) ? ( faces[1] + 1 ) : 0;
			complete1= 1;
			robots[1].setSpeed(200, 200);
		}
		else if ( ( stable1 == 1 ) && ( (x3 - x3_ref) >= 2.0 ) ) {
			while ( ( complete1 == 0 ) && ( abs(rotation_angle1) <= 15.25 ) ) {
				robots[1].setSpeed(100, -100);
				rotation_angle1 += (robots[1].getGyroRaw(2) - 0.0) * (250.0 / 32768.0) * (3.14 / 180.0);
			}
			rotation_angle1 = 0.0;
			faces[1] = ( faces[1] > 0 ) ? ( faces[1] - 1 ) : 3;
			complete1= 1;
			robots[1].setSpeed(200, 200);
		}
		else if ( ( stable1 == 1) && ( abs(x3_ref - x3) < 2.0 ) ) {
			m = ( (faces[2] - faces[1]) >= 0 ) ? 1 : -1;
			while ( abs(rotation_angle1) <= ((faces[2] - faces[1]) * 15.25) ) {
				robots[1].setSpeed( (-m * 100), (m * 100) );
				rotation_angle1 += (robots[1].getGyroRaw(2) - 0.0) * (250.0 / 32768.0) * (3.14 / 180.0);
			}
			rotation_angle1 = 0.0;
			faces[1] = faces[2];
	...
	else if ( ( robots[2].getDistanceMillimeters() <= 30 ) && ( x1 > 400.0 ) ) {
		faces[2] = 1;
		x2_ref = x1 - 100.0;
		y2_ref = y1 + ( sqrt(3) * (x2_ref - x1) );
		x3_ref = x1 - 100.0;
	...
	else if ( robots[2].getDistanceMillimeters() >= 90 && y1 > 400.0 ) {
		faces[2] = 2;
		x2_ref = x1 + 100.0;
		y2_ref = y1 + ( sqrt(3) * (x2_ref - x1) );
		x3_ref = x1 - 100.0;
		...
		std::cout << "The topology doesn't compute. Sorry." << std::endl;
	} */
#endif
}
